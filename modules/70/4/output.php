...
if (!function_exists('printVideos')) {
    ...
    function printVideos($videos):void
    {
        ...
        foreach ($videos as $video) {
            ...
            echo '<video controls preload="metadata"><source src="'. rex_escape(rex_url::media($video), 'html_attr') .'" type="'. rex_escape((string) $media->getType(), 'html_attr') .'"></video>';
            echo '</div>';
            echo '</div>';
        }
        echo '</div>';
...
if (!function_exists('printRevocationNoticeLinks')) {
    ...
    function printRevocationNoticeLinks(string $property_url, string $notice_file, string $modal_id): void
    {
        ...
        echo '<li><small><a href="#'. $modal_id .'" data-bs-toggle="modal" data-bs-target="#'. $modal_id .'" data-d2u-print-modal="'. $modal_id .'" data-d2u-print-target="'. $property_url .'?print=small"><span class="icon print"></span> '. \Sprog\Wildcard::get('d2u_immo_print_short_expose') .'</a></small></li>';
        echo '<li><small><a href="#'. $modal_id .'" data-bs-toggle="modal" data-bs-target="#'. $modal_id .'" data-d2u-print-modal="'. $modal_id .'" data-d2u-print-target="'. $property_url .'?print=full"><span class="icon print"></span> '. \Sprog\Wildcard::get('d2u_immo_print_expose') .'</a></small></li>';
    }
}
...
<div id="d2u_immo_module_70_4" class="col-12 d2u-immo-detail-bs5<?= null !== $print ? ' d2u-immo-auto-print' : '' ?>">
    <div class="row">
...
if (filter_input(INPUT_GET, 'property_id', FILTER_VALIDATE_INT, ['options' => ['default' => 0]]) > 0 || 'property_id' === $url_namespace) {
    ...
    if (null === $print) {
        ...
        echo '<li class="nav-item" role="presentation"><button type="button" data-bs-toggle="tab" data-bs-target="#tab_overview" class="nav-link active"><span class="icon home d-md-none"></span><span class="d-none d-md-block">'. \Sprog\Wildcard::get('d2u_immo_tab_overview') .'</span></button></li>';
        ...
        if (count($property->video_files) > 0) {
            echo '<li class="nav-item" role="presentation"><button type="button" data-bs-toggle="tab" class="nav-link" data-bs-target="#tab_videos"><span class="icon video d-md-none"></span><span class="d-none d-md-block">'. \Sprog\Wildcard::get('d2u_immo_tab_videos') .'</span></button></li>';
        }
        if ($show_map) {
        ...
        if ('KAUF' === $property->market_type) {
            echo '<li class="nav-item" role="presentation"><button type="button" data-bs-toggle="tab" class="nav-link" data-bs-target="#tab_calculator"><span class="icon money d-md-none"></span><span class="d-none d-md-block">'. \Sprog\Wildcard::get('d2u_immo_tab_calculator') .'</span></button></li>';
        }
        echo '<li class="nav-item" role="presentation"><button type="button" data-bs-toggle="tab" class="nav-link" data-bs-target="#tab_request" id="tab_request_pill"><span class="icon request d-md-none"></span><span class="d-none d-md-block">'. \Sprog\Wildcard::get('d2u_immo_tab_request') .'</span></button></li>';
        echo '<li class="nav-item" role="presentation"><button type="button" data-bs-toggle="tab" class="nav-link" data-bs-target="#tab_recommendation"><span class="icon forward d-md-none"></span><span class="d-none d-md-block">'. \Sprog\Wildcard::get('d2u_immo_tab_recommendation') .'</span></button></li>';
        echo '</ul>';
        echo '</div>';
    }
