    ...
    public function save()
    {
        ...
        if (0 === $this->property_id || $pre_save_object !== $this) {
            $query = rex::getTablePrefix() .'d2u_immo_properties SET '
                    ...
                    .'city = :city, '
                    .'cold_rent = '. (float) $this->cold_rent .', '
                    .'price_plus_vat = '. ($this->price_plus_vat ? 1 : 0) .', '
                    .'condition_type = :condition_type, '
                    .'construction_year = '. (int) $this->construction_year .', '
                    .'contact_id = '. ($this->contact instanceof Contact ? (int) $this->contact->contact_id : 0) .', '
                    ...
                    .'energy_efficiency_class_manual = :energy_efficiency_class_manual, '
                    .'energy_pass_building_type = :energy_pass_building_type, '
                    .'energy_pass_electricity_value = :energy_pass_electricity_value, '
                    .'energy_pass_heat_value = :energy_pass_heat_value, '
                    .'energy_pass_issue_date = :energy_pass_issue_date, '
                    .'energy_pass = :energy_pass, '
                    .'energy_pass_valid_until = :energy_pass_valid_until, '
                    .'energy_pass_year = :energy_pass_year, '
                    .'firing_type = :firing_type, '
                    .'floor = '. (int) $this->floor .', '
                    .'floor_type = :floor_type, '
                    .'ground_plans = :ground_plans, '
                    .'hall_warehouse_type = :hall_warehouse_type, '
                    .'heating_type = :heating_type, '
                    .'house_number = :house_number, '
                    .'house_type = :house_type, '
                    .'including_warm_water = '. ($this->including_warm_water ? 1 : 0) .', '
                    .'internal_object_number = :internal_object_number, '
                    .'kitchen = :kitchen, '
                    ...
                    .'openimmo_object_id = :openimmo_object_id, '
                    .'other_type = :other_type, '
                    .'parking_space_duplex = '. (int) $this->parking_space_duplex .', '
                    .'parking_space_garage = '. (int) $this->parking_space_garage .', '
                    .'parking_space_simple = '. (int) $this->parking_space_simple .', '
                    .'parking_space_undergroundcarpark = '. (int) $this->parking_space_undergroundcarpark .', '
                    ...
                    .'rooms = '. (float) $this->rooms .', '
                    .'street = :street, '
                    .'total_area = '. (float) $this->total_area .', '
                    .'type_of_use = :type_of_use, '
                    .'wheelchair_accessable = '. ($this->wheelchair_accessable ? 1 : 0) .', '
                    .'zip_code = :zip_code ';
            $query .= ', openimmo_anid = :openimmo_anid ';
            $query .= ', window_advertising_status = :window_advertising_status ';

            if (0 === $this->property_id) {
                $query = 'INSERT INTO '. $query;
            } else {
                $query = 'UPDATE '. $query .' WHERE property_id = '. (int) $this->property_id;
            }
            $result = rex_sql::factory();
            $result->setQuery($query, [
                ...
                ':openimmo_anid' => $this->openimmo_anid,
                ':window_advertising_status' => 'online' === $this->window_advertising_status ? 'online' : 'offline',
            ]);
            if (0 === $this->property_id) {
