...
class d2u_immo_lang_helper {
	...
	protected $replacements_english = [
		...
		'd2u_immo_form_privacy_policy' => 'I consent to the storage and processing of my contact and usage data by the owner of the guestbook. I\'ve learned about the scope of data processing <a href="+++LINK_PRIVACY_POLICY+++" target="_blank">here</a>. I have the right to object to such use at any time under the contact details provided in the <a href="+++LINK_IMPRESS+++" target="_blank">imprint</a>.',
