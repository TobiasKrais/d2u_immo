...
class LangHelper extends \TobiasKrais\D2UHelper\ALangHelper
{
    ...
    public $replacements_english = [
        ...
        'd2u_immo_description_location' => 'Location description',
        ...
        'd2u_immo_energy_efficiency_class' => 'Energy efficiency class',
        ...
        'd2u_immo_energy_pass_building_type' => 'Building type according to energy pass',
        'd2u_immo_energy_pass_building_type_nichtwohn' => 'Non-residential building',
        'd2u_immo_energy_pass_building_type_wohn' => 'Residential building',
        'd2u_immo_energy_pass_electricity_value' => 'Electricity value',
        'd2u_immo_energy_pass_heat_value' => 'Heat value',
        'd2u_immo_energy_pass_issue_date' => 'Issue date',
        ...
        'd2u_immo_heating_type' => 'Heating type',
        'd2u_immo_heating_type_ETAGE' => 'Floor heating',
        'd2u_immo_heating_type_FERN' => 'District heating',
        'd2u_immo_heating_type_FUSSBODEN' => 'Underfloor heating',
        'd2u_immo_heating_type_OFEN' => 'Stove heating',
        'd2u_immo_heating_type_ZENTRAL' => 'Central heating',
        ...
        'd2u_immo_recommendation_privacy_policy' => 'Privacy policy: we will not save or evaluate any part of the message. It is directly sent to the recipient.',
        'd2u_immo_recommendation_message' => 'Message for Receipient',
        'd2u_immo_recommendation_receipient_mail' => 'Recipient email address',
        'd2u_immo_recommendation_receipient_name' => 'Receipient name',
        'd2u_immo_recommendation_sender_mail' => 'Your email address',
        ...
        'd2u_immo_recommendation_validate_receipient_mail' => 'Please enter the recipient\'s correct email address.',
        'd2u_immo_recommendation_validate_receipient_name' => 'Please enter the recipient\'s name.',
        'd2u_immo_recommendation_validate_sender_mail' => 'Please enter your email address.',
        'd2u_immo_recommendation_validate_sender_name' => 'Please enter your name.',
        'd2u_immo_revocation_notice_cancel' => 'Cancel',
        'd2u_immo_revocation_notice_continue' => 'Open print view',
        'd2u_immo_revocation_notice_open_pdf' => 'Open revocation policy',
        'd2u_immo_revocation_notice_text' => 'Please review our revocation policy before printing the expose.',
        'd2u_immo_revocation_notice_title' => 'Revocation policy',
    ...
    protected array $replacements_german = [
        ...
        'd2u_immo_courtage_incl_vat' => 'inklusive gesetzlicher Mehrwertsteuer',
        ...
        'd2u_immo_energy_efficiency_class' => 'Energieeffizienzklasse',
        'd2u_immo_energy_pass_incl_warm_water' => 'mit Warmwasser',
        'd2u_immo_energy_pass_BEDARF' => 'Bedarf',
        'd2u_immo_energy_pass_building_type' => 'Gebäudeart laut Energieausweis',
        'd2u_immo_energy_pass_building_type_nichtwohn' => 'Nichtwohngebäude',
        'd2u_immo_energy_pass_building_type_wohn' => 'Wohngebäude',
        'd2u_immo_energy_pass_electricity_value' => 'Stromwert',
        'd2u_immo_energy_pass_heat_value' => 'Wärmewert',
        'd2u_immo_energy_pass_issue_date' => 'Ausstellungsdatum',
        ...
        'd2u_immo_form_thanks' => 'Danke für Ihre Nachricht. Wir kümmern uns schnellstmöglich um Ihr Anliegen.',
        ...
        'd2u_immo_heating_type' => 'Heizungsart',
        'd2u_immo_heating_type_ETAGE' => 'Etagenheizung',
        'd2u_immo_heating_type_FERN' => 'Fernwärme',
        'd2u_immo_heating_type_FUSSBODEN' => 'Fussbodenheizung',
        'd2u_immo_heating_type_OFEN' => 'Ofenheizung',
        'd2u_immo_heating_type_ZENTRAL' => 'Zentralheizung',
        ...
        'd2u_immo_no' => 'Nein',
        'd2u_immo_no_machines' => 'Es tut uns leid. Im Moment haben wir keine Angebote verfügbar. Bitte versuchen Sie es später noch einmal.',
        ...
        'd2u_immo_revocation_notice_cancel' => 'Abbrechen',
        'd2u_immo_revocation_notice_continue' => 'Druckansicht öffnen',
        'd2u_immo_revocation_notice_open_pdf' => 'Widerrufsbelehrung öffnen',
        'd2u_immo_revocation_notice_text' => 'Bitte beachten Sie vor dem Druck des Exposés unsere Widerrufsbelehrung.',
        'd2u_immo_revocation_notice_title' => 'Widerrufsbelehrung',
