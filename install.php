...
\rex_sql_table::get(\rex::getTable('d2u_immo_properties'))
    ...
    ->ensureColumn(new \rex_sql_column('energy_efficiency_class_manual', 'VARCHAR(4)', true))
    ->ensureColumn(new \rex_sql_column('energy_pass_issue_date', 'VARCHAR(50)', true))
    ->ensureColumn(new \rex_sql_column('energy_pass_building_type', 'VARCHAR(32)', true))
    ->ensureColumn(new \rex_sql_column('energy_pass_electricity_value', 'VARCHAR(191)', true))
    ->ensureColumn(new \rex_sql_column('energy_pass_heat_value', 'VARCHAR(191)', true))
