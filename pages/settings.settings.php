<?php
use TobiasKrais\D2UImmo\ExportCronjob;
...
if ('save' === filter_input(INPUT_POST, 'btn_save')) {
    ...
    if (rex_config::set('d2u_immo', $settings)) {
        ...
        if (\rex_addon::get('url')->isAvailable() && $settings['article_id'] > 0) {
            BackendHelper::update_url_scheme(rex::getTablePrefix() .'d2u_immo_url_categories', $settings['article_id']);
            BackendHelper::update_url_scheme(rex::getTablePrefix() .'d2u_immo_url_properties', $settings['article_id']);
        }

        // Install / update language replacements
        LangHelper::factory()->install();

        // Install / remove Cronjob(s)
        $export_cronjob = ExportCronjob::factory();
		...
		<div class="panel-body">
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        BackendHelper::form_linkfield('d2u_immo_settings_article', '1', (int) rex_config::get('d2u_immo', 'article_id'), (int) rex_config::get('d2u_helper', 'default_lang'));
                    ?>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        BackendHelper::form_checkbox('d2u_helper_lang_wildcard_overwrite', 'settings[lang_wildcard_overwrite]', 'true', 'true' === rex_config::get('d2u_immo', 'lang_wildcard_overwrite'));
			...
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        ...
                        BackendHelper::form_select('d2u_helper_sort', 'settings[default_category_sort]', $options_category_sort, [(string) rex_config::get('d2u_immo', 'default_category_sort')]);
                    ?>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        ...
                        BackendHelper::form_select('d2u_helper_sort', 'settings[default_property_sort]', $options, [(string) rex_config::get('d2u_immo', 'default_property_sort')]);
                        BackendHelper::form_mediafield('d2u_immo_settings_even_informative_pdf', 'even_informative_pdf', '' !== rex_config::get('d2u_immo', 'even_informative_pdf') ? (string) rex_config::get('d2u_immo', 'even_informative_pdf') : '');
                        BackendHelper::form_mediafield('d2u_immo_settings_widerrufsbelehrung', 'widerrufsbelehrung', '' !== rex_config::get('d2u_immo', 'widerrufsbelehrung') ? (string) rex_config::get('d2u_immo', 'widerrufsbelehrung') : '');
                    ?>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        ...
                        BackendHelper::form_input('d2u_immo_settings_finance_calculator_real_estate_tax', 'settings[finance_calculator_real_estate_tax]', (string) rex_config::get('d2u_immo', 'finance_calculator_real_estate_tax'), true, false, 'text');
                        BackendHelper::form_input('d2u_immo_settings_finance_calculator_notary_costs', 'settings[finance_calculator_notary_costs]', (string) rex_config::get('d2u_immo', 'finance_calculator_notary_costs'), true, false, 'text');
                        BackendHelper::form_input('d2u_immo_settings_finance_calculator_interest_rate', 'settings[finance_calculator_interest_rate]', (string) rex_config::get('d2u_immo', 'finance_calculator_interest_rate'), true, false, 'text');
                        BackendHelper::form_input('d2u_immo_settings_finance_calculator_repayment', 'settings[finance_calculator_repayment]', (string) rex_config::get('d2u_immo', 'finance_calculator_repayment'), true, false, 'text');
                    ?>
				</div>
			</fieldset>
			<fieldset>
				...
				<div class="panel-body-wrapper slide">
					<?php
                        BackendHelper::form_checkbox('d2u_immo_export_settings_autoexport', 'settings[export_autoexport]', 'active', (bool) rex_config::get('d2u_immo', 'export_autoexport', false));
                        BackendHelper::form_input('d2u_immo_export_settings_email', 'settings[export_failure_email]', (string) rex_config::get('d2u_immo', 'export_failure_email'), true, false, 'email');
                    ?>
				</div>
			</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
                        ...
                        if (count(rex_clang::getAll()) > 1) {
                            ...
                            BackendHelper::form_select('d2u_immo_import_settings_default_lang', 'settings[import_default_lang]', $lang_options, [(int) rex_config::get('d2u_immo', 'import_default_lang')]);
                        }
                        $options_categories = [];
                        foreach (TobiasKrais\D2UImmo\Category::getAll((int) rex_config::get('d2u_helper', 'default_lang')) as $category) {
                            if ('' !== $category->name) {
                                $options_categories[$category->category_id] = ($category->parent_category instanceof TobiasKrais\D2UImmo\Category ? $category->parent_category->name .' → ' : '') . $category->name;
                            }
                        }
                        asort($options_categories);
                        BackendHelper::form_select('d2u_immo_import_settings_category', 'settings[import_category_id]', $options_categories, [(int) rex_config::get('d2u_immo', 'import_category_id', 0)]);
                        ?>
						...
						<?php
                        BackendHelper::form_input('d2u_immo_import_settings_email', 'settings[import_email]', (string) rex_config::get('d2u_immo', 'import_email'), true, false, 'email');
                        BackendHelper::form_input('d2u_immo_import_settings_import_folder', 'settings[import_folder]', (string) rex_config::get('d2u_immo', 'import_folder'), false, false);
                        BackendHelper::form_infotext('d2u_immo_import_settings_import_folder_hint', 'import_folder_hint');
                        BackendHelper::form_checkbox('d2u_immo_import_settings_autoimport', 'settings[import_autoimport]', 'active', (bool) rex_config::get('d2u_immo', 'import_autoimport', false));
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                        BackendHelper::form_linkfield('d2u_immo_window_advertising_settings_article', '2', (int) rex_config::get('d2u_immo', 'window_advertising_settings_article'), (int) rex_config::get('d2u_helper', 'default_lang'))
                        ?>
					</div>
				</fieldset>
		</div>
