				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
                        ...
                        if (count(rex_clang::getAll()) > 1) {
                            ...
                            \TobiasKrais\D2UHelper\BackendHelper::form_select('d2u_immo_import_settings_default_lang', 'settings[import_default_lang]', $lang_options, [(int) rex_config::get('d2u_immo', 'import_default_lang')]);
                        }
                        $options_categories = [];
