						...
						<div class="panel-body-wrapper slide">
							<?php
                                if ($rex_clang->getId() !== (int) rex_config::get('d2u_helper', 'default_lang')) {
                                    ...
                                    BackendHelper::form_select('d2u_helper_translation', 'form[lang]['. $rex_clang->getId() .'][translation_needs_update]', $options_translations, [$property->translation_needs_update], 1, false, $readonly_lang);
                                } else {
							...
							<div id="details_clang_<?= $rex_clang->getId() ?>">
								<?php
                                    ...
                                    BackendHelper::form_textarea('d2u_immo_property_description_others', 'form[lang]['. $rex_clang->getId() .'][description_others]', $property->description_others, 5, false, $readonly_lang, true);
                                    BackendHelper::form_medialistfield('d2u_immo_property_documents', 10 + $rex_clang->getId(), $property->documents, $readonly_lang);
                                ?>
							</div>
						</div>
					</fieldset>
				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            ...
                            BackendHelper::form_select('d2u_helper_category', 'form[category_id]', $options_categories, $property->category instanceof Category ? [$property->category->category_id] : [], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_type_of_use', 'form[type_of_use]', $options_type_of_use, [$property->type_of_use], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_market_type', 'form[market_type]', $options_market_type, [$property->market_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_type', 'form[object_type]', $options_object_type, [$property->object_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[apartment_type]', $options_apartment_type, [$property->apartment_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[house_type]', $options_house_type, [$property->house_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[land_type]', $options_land_type, [$property->land_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[office_type]', $options_office_type, [$property->office_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[hall_warehouse_type]', $options_hall_warehouse_type, [$property->hall_warehouse_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[parking_type]', $options_parking_type, [$property->parking_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_object_subtype', 'form[other_type]', $options_other_type, [$property->other_type], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_condition_type', 'form[condition_type]', $options_condition_type, [$property->condition_type], 1, false, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_listed_monument', 'form[listed_monument]', 'true', $property->listed_monument, $readonly);
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            BackendHelper::form_input('d2u_immo_contact_street', 'form[street]', $property->street, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_house_number', 'form[house_number]', $property->house_number, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_contact_zip_code', 'form[zip_code]', $property->zip_code, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_contact_city', 'form[city]', $property->city, false, $readonly, 'text');
                            ...
                            BackendHelper::form_select('d2u_immo_property_country_code', 'form[country_code]', $options_country_code, [$property->country_code], 1, false, $readonly);
						...
						<?php
                                ...
                                BackendHelper::form_infotext('d2u_immo_geocode_hint_manual', 'hint_geocoding');
                            }
                            BackendHelper::form_input('d2u_immo_property_longitude', 'form[longitude]', (string) $property->longitude, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_latitude', 'form[latitude]', (string) $property->latitude, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_floor', 'form[floor]', $property->floor, false, $readonly, 'number');
                            BackendHelper::form_checkbox('d2u_immo_property_publish_address', 'form[publish_address]', 'true', $property->publish_address, $readonly);
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            BackendHelper::form_checkbox('d2u_immo_property_flat_sharing_possible', 'form[flat_sharing_possible]', 'true', $property->flat_sharing_possible, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_bath', 'form[bath][]', $options_bath, $property->bath, 5, true, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_kitchen', 'form[kitchen][]', $options_kitchen, $property->kitchen, 3, true, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_floor_type', 'form[floor_type][]', $options_floor_type, $property->floor_type, 5, true, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_heating_type', 'form[heating_type][]', $options_heating_type, $property->heating_type, 5, true, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_elevator', 'form[elevator][]', $options_elevator, $property->elevator, 2, true, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_wheelchair_accessable', 'form[wheelchair_accessable]', 'true', $property->wheelchair_accessable, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_cable_sat_tv', 'form[cable_sat_tv]', 'true', $property->cable_sat_tv, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_broadband_internet', 'form[broadband_internet][]', $options_broadband_internet, $property->broadband_internet, 5, true, $readonly);
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            ...
                            BackendHelper::form_select('d2u_immo_property_energy_pass', 'form[energy_pass_year]', $options_energy_pass_year, [$property->energy_pass_year], 1, false, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_firing_type', 'form[firing_type][]', $options_firing_type, $property->firing_type, 5, true, $readonly);
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            BackendHelper::form_checkbox('d2u_immo_property_purchase_price_on_request', 'form[purchase_price_on_request]', 'false', $property->purchase_price_on_request, $readonly);
                            ...
                            BackendHelper::form_select('d2u_immo_property_currency_code', 'form[currency_code]', $options_currency_code, [$property->currency_code], 1, false, $readonly);
                            BackendHelper::form_input('d2u_immo_property_purchase_price', 'form[purchase_price]', $property->purchase_price, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_purchase_price_m2', 'form[purchase_price_m2]', $property->purchase_price_m2, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_cold_rent', 'form[cold_rent]', $property->cold_rent, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_additional_costs', 'form[additional_costs]', $property->additional_costs, false, $readonly, 'number');
                            BackendHelper::form_checkbox('d2u_immo_property_price_plus_vat', 'form[price_plus_vat]', 'true', $property->price_plus_vat, $readonly);
                            BackendHelper::form_input('d2u_immo_property_deposit', 'form[deposit]', $property->deposit, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_courtage', 'form[courtage]', $property->courtage, false, $readonly, 'text');
                            BackendHelper::form_checkbox('d2u_immo_property_courtage_incl_vat', 'form[courtage_incl_vat]', 'true', $property->courtage_incl_vat, $readonly);
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            BackendHelper::form_input('d2u_immo_property_construction_year', 'form[construction_year]', $property->construction_year, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_living_area', 'form[living_area]', (string) $property->living_area, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_total_area', 'form[total_area]', (string) $property->total_area, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_land_area', 'form[land_area]', (string) $property->land_area, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_rooms', 'form[rooms]', (string) $property->rooms, false, $readonly, 'text');
                            BackendHelper::form_input('d2u_immo_property_parking_space_duplex', 'form[parking_space_duplex]', $property->parking_space_duplex, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_parking_space_simple', 'form[parking_space_simple]', $property->parking_space_simple, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_parking_space_garage', 'form[parking_space_garage]', $property->parking_space_garage, false, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_parking_space_undergroundcarpark', 'form[parking_space_undergroundcarpark]', $property->parking_space_undergroundcarpark, false, $readonly, 'number');
                        ?>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            ...
                            BackendHelper::form_select('d2u_immo_status', 'form[online_status]', $options_status, [$property->online_status], 1, false, $readonly);
                            if (rex_plugin::get('d2u_immo', 'window_advertising')->isAvailable()) {
                                BackendHelper::form_checkbox('d2u_immo_window_advertising_show', 'form[window_advertising_status]', 'true', 'online' === $property->window_advertising_status, $readonly);
                            }
                            BackendHelper::form_input('d2u_immo_property_internal_object_number', 'form[internal_object_number]', $property->internal_object_number, true, $readonly, 'text');
                            BackendHelper::form_input('header_priority', 'form[priority]', $property->priority, true, $readonly, 'number');
                            BackendHelper::form_input('d2u_immo_property_available_from', 'form[available_from]', $property->available_from, false, $readonly, 'date');
                            BackendHelper::form_checkbox('d2u_immo_property_rented', 'form[rented]', 'true', $property->rented, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_animals', 'form[animals]', 'true', $property->animals, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_object_reserved', 'form[object_reserved]', 'true', $property->object_reserved, $readonly);
                            BackendHelper::form_checkbox('d2u_immo_property_object_sold', 'form[object_sold]', 'true', $property->object_sold, $readonly);
                            $options_contacts = [];
