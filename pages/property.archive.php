...
if ('' === $func) { /** @phpstan-ignore-line */
    ...
    $list->setColumnFormat(rex_i18n::msg('d2u_helper_open_frontend'), 'custom', static function ($params) {
        ...
        return BackendHelper::getFrontendLinkButton((new \TobiasKrais\D2UImmo\Property((int) $listParams->getValue('property_id'), (int) rex_config::get('d2u_helper', 'default_lang')))->getUrl());
    });
