...
<ul>
	...
	<li>Backend: In den Formularen für Immobilien und Kategorien wird jetzt direkt an den betroffenen Feldern angezeigt, wofür sie im Frontend/SEO verwendet werden: der Name als Meta-Titel, der Teaser als Meta-Beschreibung und der Hinweis, dass das (erste) Bild für die SEO-/Social-Media-Vorschau (<code>og:image</code>) genutzt wird.</li>
</ul>
<p>1.5.1:</p>
<ul>
...
<ul>
	...
	<li>Die Priorität von Kategorien, aktiven und archivierten Immobilien sowie Schaufenster-Anzeigen kann in den Backend-Listen jetzt direkt per Hoch-/Runter-Buttons geändert werden.</li>
</ul>
<p>1.4.2:</p>
<ul>
