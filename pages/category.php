...
if ('' === $func) {
    ...
    $list->setColumnFormat(rex_i18n::msg('d2u_helper_open_frontend'), 'custom', static function ($params) {
        ...
        return BackendHelper::getFrontendLinkButton((new \TobiasKrais\D2UImmo\Category((int) $listParams->getValue('category_id'), (int) rex_config::get('d2u_helper', 'default_lang')))->getUrl());
    });
