	...
	<form action="<?php print rex_url::currentBackendPage(); ?>" method="post">
		<div class="panel panel-edit">
			...
			<div class="panel-body">
						...
						<div class="panel-body-wrapper slide">
							<?php
								if($rex_clang->getId() != rex_config::get("d2u_immo", "default_lang")) {
									...
									d2u_addon_backend_helper::form_select('d2u_immo_translation', 'form[lang]['. $rex_clang->getId() .'][translation_needs_update]', $options_translations, array($category->translation_needs_update), 1, FALSE, $readonly_lang);
								}
								else {
				...
				?>
				<fieldset>
					<legend><?php echo rex_i18n::msg('d2u_immo_data_all_lang'); ?></legend>
					<div class="panel-body-wrapper slide">
						<?php
